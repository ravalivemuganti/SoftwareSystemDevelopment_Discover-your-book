<%@page import="DicoverBook.Course"%>
...
<%
ArrayList<Course> courses = (ArrayList<Course>) request.getAttribute("courseDetails");

for(int i=0; i<courses.size();i++)
{
	    out.println("<td>"+courses.get(i).getIsbn()+"</td>");
   	    out.println("<td>"+courses.get(i).getBook_name()+"</td>");
        out.println("<td>"+courses.get(i).getCourse_name()+"</td>");
        out.println("<td>"+courses.get(i).getBook_learner_level()+"</td>");
        out.println("<td>"+courses.get(i).getRating()+"</td>");
        out.println("<td>"+courses.get(i).getEdition()+"</td>");
        out.println("<td><input type=\"radio\" value=\""+courses.get(i).getIsbn()+"\" name=\"isbn\"  onClick=\"submit();\"></td>");
		out.println("</tr>");
