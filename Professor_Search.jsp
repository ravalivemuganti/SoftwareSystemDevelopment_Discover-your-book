...
<form action="Professor_Search" method="post">
    <div id="login_section">
		<h4>Welcome <%=session.getAttribute("username") %></h4>

	</div>
<div id="section">
<h4>Searching by professor name: </h4>
<br>
Professor First Name: <input type="text" name="professorfirstname">
<br>
<br>
Professor Last Name: <input type="text" name="professorlastname">
<br>
<br>
